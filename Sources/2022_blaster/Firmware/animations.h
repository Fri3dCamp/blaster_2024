...
namespace Animations
{
  ...
  void set_team_status(uint8_t team, uint8_t hitpoints)
  {
    Leds.setPixelColor(0, _teamToColor(team, 255));
    if (hitpoints) {
      if (hitpoints > 3) Leds.setPixelColor(1, _teamToColor(team, 25));
      if (hitpoints > 2) Leds.setPixelColor(2, _teamToColor(team, 25));
      if (hitpoints > 1) Leds.setPixelColor(3, _teamToColor(team, 25));
      if (hitpoints > 0) Leds.setPixelColor(4, _teamToColor(team, 25));
    }
    else
  ...
  void team_switch(uint8_t team, uint8_t hitpoints)
  {
    set_team_status(team, hitpoints);
